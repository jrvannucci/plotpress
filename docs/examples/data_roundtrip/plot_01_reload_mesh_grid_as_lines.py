...
:func:`plotpress.subplots_from_html` rebuilds an equivalent,
...
# panel, replotted into a *rebuilt* 5x6 grid: subplots_from_html() reads
...
# exception -- see subplots_from_html()'s own docstring -- so it's the
