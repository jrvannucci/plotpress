...
hosting the same interactive SVG: the menu bar (Pan/Zoom, Home, Axes,
Point Picking, Annotate, File) works here too, exactly as it does in a
browser. Close the window to end the program.
