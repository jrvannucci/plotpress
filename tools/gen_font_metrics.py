"""Regenerate ``simpleplot/fonts/metrics.py`` from authoritative metric sources.
...
normal install and test run needs none of the sources below.
    ...
    python tools/gen_font_metrics.py > simpleplot/fonts/metrics.py
...
HEADER = '''"""Advance-width tables for the fonts simpleplot can measure.
